...
class Transformer(nn.Module):
    def __init__(
        ...
        self.output_layer_finetune_bad = nn.Sequential(
    ...
    def forward(self, src, mask_indices):
        ...
        if(mask_indices not in ["finetune", "sametimbre", "finetune_switch", "sametimbre_switch", "samesession", "ntp"]):
            batch_MSK_tokens = []
        ...
        #print("batch MSK tokens has shape "+str(batch_MSK_tokens.shape))  #should be batchsize by voxel_dim
            ...
            #return out_finetune
        elif(mask_indices in ["sametimbre", "samesession", "ntp"]):
